...
evidence = {
  ...
  "ev-sd-years": {"title": "13+ years designing services", "text": "Service design lead with 13+ years designing how people move through complex products, services, and operations — including senior service design and design strategy roles across Bayer Crop Science's $27B division — grounded in lived experience running the kinds of operations most designers have only mapped."},
  ...
  "ev-eraf": {"title": "The map that kept people", "text": "At my startup, employees were ready to quit over 'bad communication.' Ethnographic research showed the real problem: they couldn't see the larger business system. I built an ERAF map of 100+ interaction points that let siloed teams see their role in the whole — and they stayed."},
  "ev-metrics": {"title": "Impact you can measure", "text": "Fluent in success metrics: OKRs, KPIs, adoption rate, time-to-launch, satisfaction. Drove measurable outcomes like a 35% lift in product and service opportunities, a 30% rise in workplace safety, and 2% to 26% platform adoption in two months."},
  "ev-ad-constraints": {"title": "Vision despite constraints, 40 productions", "text": "As an assistant director, my whole job was making the director's vision possible despite budget, time, and resource constraints — developing, roadmapping, and implementing the operational plan across 40 productions."},
  ...
  "ev-agile": {"title": "Agile from backlog to UAT", "text": "Worked inside agile product teams across four Bayer platforms: refined backlogs, aligned hundreds of technical stories to user needs, led user acceptance testing across the North American user base, and built out the scrum board — writing all the stories — for a legacy platform team that had none."},

  # -- collaboration / facilitation / communication --
  "ev-delta-pm": {"title": "Nine disciplines, eight countries, one team", "text": "Product Manager on a Delta Air Lines engagement: led a cross-cultural team spanning eight countries and nine disciplines, owned budget, timelines, and stakeholder relationships, and was the primary contact between client and team — presenting regularly in Delta's corporate rooms."},
  ...
  "ev-ags-consulting": {"title": "Trusted advisor to leadership teams", "text": "As a consultant to franchisees and franchisors, I build relationships, influence, and drive the strategic alignment needed to get the opportunity to design new systems and lead enterprise transformation."},
  ...
  "ev-mentor": {"title": "Developing the people around me", "text": "Ran training and development for a 250-person camp staff — a redesigned program that lifted retention 67% year over year — and spent six years in film identifying underutilized talent, developing them through on-set mentor matching, and launching them to lead their own crews."},
  ...
  # -- mission / service --
  "ev-mission-service": {"title": "A career built on service", "text": "Before I had the word 'design' for it, my work was service: seven summers on staff at a 1,500-person residential summer camp, a leadership development practice for high school and college students, and cohort-based men's work that still runs today. I've always been happiest helping a team serve people better."},
  "ev-systems-for-people": {"title": "Helping people see the unseen", "text": "I'm a systems guy. I love helping people see the unseen — the maps, blueprints, and playbooks that show how their work fits into the whole — and public services are exactly that kind of system. The most fulfilling work I've done is being in the mud with a team that's actively creating change."},
  ...
  "ev-responsible-ai": {"title": "Responsible AI before the boom", "text": "I've been integrating AI into human systems since before commercial integrations existed — agentic personas validated by 20+ year subject-matter experts above 80% accuracy before teams were allowed to rely on them, and stakeholder education from Indonesia to Brazil. Adoption only counts if people can trust the tool."},
  ...
  "ev-portfolio": {"title": "Portfolio at hance.work", "text": "Twelve public case studies across service blueprints, journey maps, systems maps, AI strategy, and UX — each one walks through the process, the deliverables, and the impact."},
