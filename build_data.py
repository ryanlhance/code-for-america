...
evidence = {
  ...
  "ev-sd-years": {"title": "7+ years in service design", "text": "7+ years specifically in service design, but 13+ years designing how people move through complex products, services, and operations — including senior service design and design strategy roles across Bayer Crop Science's $27B division."},
  ...
  "ev-eraf": {"title": "Retained the employees planning to leave", "text": "At Dryland, employees were ready to quit over 'bad communication.' Ethnographic research showed the real problem: they couldn't see the larger business system. I built an ERAF map of 100+ interaction points that let siloed teams see their role in the whole — and they stayed."},
  "ev-metrics": {"title": "Fluent in adoption, time-to-launch, and satisfaction", "text": "Fluent in success metrics: OKRs, KPIs, adoption rate, time-to-launch, satisfaction. Drove measurable outcomes like a 35% lift in product and service opportunities, a 30% rise in workplace safety, and 2% to 26% platform adoption in two months."},
  "ev-ad-constraints": {"title": "Operational plans for 40 productions", "text": "As an assistant director, my whole job was making the director's vision possible despite budget, time, and resource constraints — I developed the concept and vision, roadmapped, and implemented the operational plan across 40 productions."},
  ...
  "ev-mentor": {"title": "Mentorship that lifted retention 67%", "text": "Ran training and development for a 250-person camp staff — a redesigned program that lifted retention 67% year over year, am a trained and practicing leadership coach, and spent six years in film identifying underutilized talent, developing them through on-set mentor matching, and launching them to lead their own crews."},
  ...
  # -- mission / service --
  "ev-mission-service": {"title": "Seven summers, thousands of kids", "text": "Seven summers on staff at a summer camp serving thousands of kids, leadership development practice for high school and college students, and cohort-based men's work currently."},
  "ev-systems-for-people": {"title": "I map the whole iceberg", "text": "My brain operates in the unseen, constantly mapping, blueprinting, and writing the playbooks for the iceberg people only see the tip of."},
  ...
  "ev-responsible-ai": {"title": "Shipping AI since before the boom", "text": "I've been integrating AI into human systems since before commercial integrations existed — agentic personas validated by 20+ year subject-matter experts above 80% accuracy before teams were allowed to rely on them, and stakeholder AI education from Indonesia to Brazil."},
  ...
  "ev-portfolio": {"title": "Twelve public case studies", "text": "Twelve public case studies across service blueprints, journey maps, systems maps, AI strategy, and UX — each one walks through the process, the deliverables, and the impact."},
